...
import com.example.user.datasourceexample.noteList.NoteViewHolder.OnItemSelectedListener;

import java.util.ArrayList;
import java.util.List;

public class NoteAdapter extends RecyclerView.Adapter<NoteViewHolder> implements OnItemSelectedListener {

    OnItemSelectedListener listener;
    private ArrayList<Note> mData;

    public NoteAdapter(ArrayList<Note> dataSet, OnItemSelectedListener listener) {
    ...
    public void addData(ArrayList<Note> dataSet) {
