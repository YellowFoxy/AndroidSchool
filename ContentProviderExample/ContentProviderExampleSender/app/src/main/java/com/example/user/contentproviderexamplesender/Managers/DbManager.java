package com.example.user.contentproviderexamplesender.Managers;
...
public class DbManager {
    ...
    public long addNewNote(Note note) {
        ...
        try {
            ...
            result = addNoteInternal(db, contentValues);
    ...
    private long addNoteInternal(SQLiteDatabase db, ContentValues cv) {
        return db.insert(DbHelper.NOTE_TABLE_NAME, null, cv);
    }
